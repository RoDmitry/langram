    ...
    L: IntoIterator<Item = ScriptLanguage>,
{
    ...
    pub(super) long_text_ngram_sizes: NgramSizes,
    pub(super) short_text_ngram_sizes: NgramSizes,
}
...
impl<'m> DetectorBuilder<'m, ScriptLanguageIter> {
    ...
    pub fn new(models_storage: &'m ModelsStorage) -> Self {
        Self {
            ...
            long_text_ngram_sizes: NgramSizes::new_const(),
            short_text_ngram_sizes: NgramSizes::new_const(),
        }
    }
}
    ...
    L: IntoIterator<Item = ScriptLanguage>,
{
    ...
    pub fn languages<L2: IntoIterator<Item = ScriptLanguage>>(
        ...
        DetectorBuilder {
            ...
            long_text_ngram_sizes: self.long_text_ngram_sizes,
            short_text_ngram_sizes: self.short_text_ngram_sizes,
        }
    }
    ...
    pub fn long_ngrams(mut self, ngrams: impl Iterator<Item = NgramSize>) -> Self {
        self.long_text_ngram_sizes = NgramSizes::new_merged(ngrams);
        self
    }
    ...
    pub fn short_ngrams(mut self, ngrams: impl Iterator<Item = NgramSize>) -> Self {
        self.short_text_ngram_sizes = NgramSizes::new_merged(ngrams);
        self
    }
    ...
    pub fn long_ngrams_add(mut self, ngrams: impl Iterator<Item = NgramSize>) -> Self {
        self.long_text_ngram_sizes.merge(ngrams);
        self
    }
    ...
    pub fn short_ngrams_add(mut self, ngrams: impl Iterator<Item = NgramSize>) -> Self {
        self.short_text_ngram_sizes.merge(ngrams);
        self
    }
    ...
    pub fn max_trigrams(mut self) -> Self {
        ...
        self.short_text_ngram_sizes = NgramSizes::new_merged(
            [
                NgramSize::Uni,
                NgramSize::Bi,
                NgramSize::Tri,
...
mod tests {
    ...
    fn test_empty_ngrams() {
        ...
        assert!(builder.long_text_ngram_sizes.is_empty());
        assert!(builder.short_text_ngram_sizes.is_empty());

        let detector = builder.build();
        assert!(!detector.long_text_ngram_sizes.is_empty());
        assert!(!detector.short_text_ngram_sizes.is_empty());
    }
